...
3. 선택한 HDL 소스를 Vivado 프로젝트에 추가합니다.
4. 핀 할당이나 hardware programming 전에 clock/reset 전제 조건을 확인합니다.
...
- 제품 적용 전에는 Vivado 프로젝트 안에서 별도 검증과 timing 확인이 필요합니다.
...
| 0.02 | Codex | 2026-02-13 | reset 처리와 LED-SW mapping 개선 |
